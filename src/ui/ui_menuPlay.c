...
int     s_ui_menuPlaySelected_exec(TUiContext argContext)
{
    enum    EItemsMenuPrincipal
    {
        EMenuItemLevel1 = 0,
        /*!< Static maze with difficulty level 1. */

        EMenuItemLevel2,
        /*!< Static maze with difficulty level 2. */

        EMenuItemLevel3,
        /*!< Static maze with difficulty level 3. */

        EMenuItemLevel4,
        /*!< Static maze with difficulty level 4. */

        EMenuItemLevel5,
        /*!< Static maze with difficulty level 5. */
    ...
    for( lIterator = 0 ; lIterator < EMenuLastItem ; lIterator++ )
    {
        ...
        switch( lIterator )
        {
            ...
            case EMenuItemLevel1:
                p_itemName          = "Level 1";
                p_itemDescription   = "";
                p_itemUserPtr       = (void*)EMenuItemLevel1;
                break;


            case EMenuItemLevel2:
                p_itemName          = "Level 2";
                p_itemDescription   = "";
                p_itemUserPtr       = (void*)EMenuItemLevel2;
                break;


            case EMenuItemLevel3:
                p_itemName          = "Level 3";
                p_itemDescription   = "";
                p_itemUserPtr       = (void*)EMenuItemLevel3;
                break;


            case EMenuItemLevel4:
                p_itemName          = "Level 4";
                p_itemDescription   = "";
                p_itemUserPtr       = (void*)EMenuItemLevel4;
                break;


            case EMenuItemLevel5:
                p_itemName          = "Level 5";
                p_itemDescription   = "";
                p_itemUserPtr       = (void*)EMenuItemLevel5;
                break;
    ...
    do
    {
        ...
        switch( lSelectedItemIndex )
        {
            ...
            case EMenuItemLevel1:
            {
                TRACE_DBG( "Selected : Level 1" );
                ui_play_selected( argContext, C_FILEPATH_GRID_L1 );
                break;
            }
            ...
            case EMenuItemLevel2:
            {
                TRACE_DBG( "Selected : Level 2" );
                ui_play_selected( argContext, C_FILEPATH_GRID_L2 );
                break;
            }
            ...
            case EMenuItemLevel3:
            {
                TRACE_DBG( "Selected : Level 3" );
                ui_play_selected( argContext, C_FILEPATH_GRID_L3 );
                break;
            }
            ...
            case EMenuItemLevel4:
            {
                TRACE_DBG( "Selected : Level 4" );
                ui_play_selected( argContext, C_FILEPATH_GRID_L4 );
                break;
            }
            ...
            case EMenuItemLevel5:
            {
                TRACE_DBG( "Selected : Level 5" );
                ui_play_selected( argContext, C_FILEPATH_GRID_L5 );
                break;
            }
...
#warning "Not implemented !"
            ...
            case EMenuItemChooseLevel:
            {
                ...
                s_ui_menuPlaySelected_exec( argContext );
                break;
            }
